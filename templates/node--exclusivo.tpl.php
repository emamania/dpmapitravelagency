...
<div class="node-socials">
	<ul>
        ...
        <li class="node-social">
        <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php print $base_root . $node_url; ?>" data-count="horizontal" data-via="MapiTravel4All" data-lang="es">Tweet</a>
        </li>
	</ul>
    </div>
  ...
  <div id="comments">
    ...
    <fb:comments href="<?php print $base_root . $node_url; ?>" num_posts="5" width="100%"></fb:comments>
  </div>
  <?php endif; ?>
